...
| Output                                                                      | Purpose                                                               |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `src/preload/api.ts` + `src/preload/contracts/*` + `src/preload/http-api/*` | Browser-safe shared HTTP API surface, contracts, and implementations. |
| `src/preload/rpc-api.ts` + `src/preload/api/*`                              | Electron preload `window.api` surface.                                |
...
- `src/renderer/src/lib/store/store.ts` for request/response data flows.
