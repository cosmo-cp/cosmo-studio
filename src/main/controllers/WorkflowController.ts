...
import type { Workflow, WorkflowCreateInput, WorkflowGraph, WorkflowRun, WorkflowRunInsert, WorkflowVersion } from 'core/dto';
...
export class WorkflowController implements Controller {
    ...
    public async runGet(input: { runId: string }): Promise<WorkflowRun | undefined> {
