...
const providerDefinitions: WebSearchProviderDefinition[] = [
    ...
    },
    {
        ...
        dialogDescription: "Store a Parallel API key in renderer state for this frontend-only search and extraction flow.",
        ...
        removeDescription: "This removes the in-memory Parallel API key from Redux state and disables the option for future chats.",
...
export function WebSearchManagement() {
    ...
    return (
        <div className="space-y-6">
            ...
            <Dialog open={activeProvider !== null} onOpenChange={(open) => {
                if (!open) {
                    handleCloseDialog();
                }
            }}>
                <DialogContent className="sm:max-w-[520px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {activeProvider?.dialogDescription}
                        </DialogDescription>
                    </DialogHeader>
                    <form className="space-y-4" onSubmit={(event) => {
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                type="password"
                                placeholder={activeProviderConfig ?
